var expensesClassification_Module_Factory = function () {
  var expensesClassification = {
    name: 'expensesClassification',
    defaultElementNamespaceURI: 'https:\/\/www.aade.gr\/myDATA\/expensesClassificaton\/v1.0',
    typeInfos: [{
    ...
    elementInfos: [{
        elementName: 'ExpensesClassificationsDoc',
...
if (typeof define === 'function' && define.amd) {
  define([], expensesClassification_Module_Factory);
}
else {
  var expensesClassification_Module = expensesClassification_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.expensesClassification = expensesClassification_Module.expensesClassification;
  }
  else {
    var expensesClassification = expensesClassification_Module.expensesClassification;
  }
}