var requestedInvoicesDoc_Module_Factory = function () {
  var requestedInvoicesDoc = {
  ...
  return {
    requestedInvoicesDoc: requestedInvoicesDoc
  };
};
if (typeof define === 'function' && define.amd) {
  define([], requestedInvoicesDoc_Module_Factory);
}
else {
  var requestedInvoicesDoc_Module = requestedInvoicesDoc_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.requestedInvoicesDoc = requestedInvoicesDoc_Module.requestedInvoicesDoc;
  }
  else {
    var requestedInvoicesDoc = requestedInvoicesDoc_Module.requestedInvoicesDoc;
  }
}