var requestDoc_Module_Factory = function () {
  var requestDoc = {
    name: 'requestDoc',
...
if (typeof define === 'function' && define.amd) {
  define([], requestDoc_Module_Factory);
}
else {
  var requestDoc_Module = requestDoc_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.requestDoc = requestDoc_Module.requestDoc;
  }
  else {
    var requestDoc = requestDoc_Module.requestDoc;
  }
}